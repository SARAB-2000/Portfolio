    ...
    return Scaffold(
      ...
      floatingActionButton: isMobile
          ? FloatingActionButton.extended(
              ...
              label: Text(l10n.mobileContactFab),
              ...
              child: SafeArea(
                child: ListView(
                  ...
                  children: [
                    ...
                    _DrawerTile(l10n.navProblems, () => _scrollToSection('problems')),
                    _DrawerTile(l10n.navServices, () => _scrollToSection('services')),
                    _DrawerTile(l10n.navProjects, () => _scrollToSection('projects')),
                    _DrawerTile(l10n.navExperience, () => _scrollToSection('experience')),
                    _DrawerTile(l10n.navAbout, () => _scrollToSection('about')),
        ...
        children: [
          ...
          CustomScrollView(
            ...
            slivers: [
                ...
                child: RepaintBoundary(
                  child: KeyedSubtree(
                    ...
                    child: HeroSection(
                      ...
                      onViewServices: () => _scrollToSection('services'),
              ...
              if (isMobile) const SliverToBoxAdapter(child: SizedBox(height: 80)),
            ],
          ),
          Positioned(
            top: 0,
